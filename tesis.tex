...
%                                   DATOS                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Inferencia estadística para modelos epidemiológicos compartamentales estocásticos}
...
\degree{Matemático Aplicado}       % Carrera
\director{Dr. Fernando Baltazar Larios}                 % Director de tesis
